<template>
	<div class="convert">
		...
		<div class="card">
			<div class="card-content">
				<p class="has-text-left is-size-6 mt-4 mb-4">Resultado - Equivalente Energético</p>
				<div class="card-elements is-inline-flex is-fullwidth">
					<div class="circle">
...
const units_1 = ref<Fuel[]>([[1, 'Unidad', 5]]);
const units_2 = ref<Fuel[]>([[1, 'Unidad', 5]]);
